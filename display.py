...
from screen import EPD_2in13_V3_Wrapper, EPD_7in5_B_Wrapper, Screen
from font_renderer import FontRenderer, FontSize
from screen_padded import PaddedScreen
...
class DisplayController:
    ...
    def __init__(self, epd: Screen, font_renderer: FontRenderer):
        self.epd = epd
...
def get_epd(config: Config) -> Screen:
    """
    Factory function that returns the appropriate EPD wrapper based on config.
    Adapts different manufacturer EPD implementations to a common Screen interface.
